...
class SignUp extends Component {
  ...
  checkDate() {
    if (validator.isDate(this.state.birthdate)) {
      console.warn("La fecha es válida");
    } else {
      console.error("Error de validación: el campo fecha no es válido ");
    }
  }
      ...
      <Container component="main" maxWidth="xs">
        ...
        <div className="paper">
          <div className="internal_paper">
            ...
            <div
              className="error_msg"
              style={this.state.signUpError ? {} : { display: "none" }}
            >
              <div className="help">
                <IconContext.Provider
            ...
            >
              ...
              <DialogContent dividers>
                <div className="dialog_content">
                  <p>
                    Es posible que ya hayas creado una cuenta anteriormente con
                    la dirección de correo especificada, en ese caso te
                    invitamos a <a href="/SignIn"> Iniciar sesión </a>
                  </p>
                </div>
              </DialogContent>
              <DialogActions>
            ...
            <form className="form" noValidate>
              ...
              <this.StyledTextField
                ...
                onChange={this.handleChange}
                error={
                  this.state.passwordError && this.state.password.length < 7
                }
                helperText={
                  this.state.passwordError && this.state.password.length < 7
